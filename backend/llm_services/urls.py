...
router.register(r'job-embeddings', views.JobDescriptionEmbeddingViewSet, basename='job-embeddings')
router.register(r'enhanced-artifacts', views.EnhancedArtifactViewSet, basename='enhanced-artifacts')
