...
describe('ArtifactEditForm', () => {
  ...
  it('validates collaborator email addresses', async () => {
    const user = userEvent.setup()
    ...
    const collabInput = screen.getByPlaceholderText(/add collaborator/i)
    await user.type(collabInput, 'invalid-email{enter}')
